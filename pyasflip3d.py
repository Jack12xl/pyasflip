...
if dim == 2:
  ...
  capsule_rotation = ti.Matrix.field(3, 3, dtype=float, shape=())
capsule_angular_vel = 80.0
capsule_translation = ti.Vector.field(dim, dtype=float, shape=())
capsule_trans_vel = ti.Vector.field(dim, dtype=float, shape=())
...
grid_v = ti.Vector.field(
  dim, dtype=float, shape=(n_grid, n_grid)
...
adv_params = ti.Vector.field(6, dtype=float, shape=()) # TODO
